...
function Footer() {
    return (
        <footer>
            <p>
                &copy; {new Date().getFullYear()} BinderTCG. Efeitos de CSS por{' '}
            ...
            <p>
                Desenvolvido por{' '}
                <a href="https://github.com/Constellarw" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: 4 }}>
                    <svg width="20" height="20" viewBox="0 0 16 16" fill="currentColor" style={{ marginRight: 4, verticalAlign: 'middle' }}>
